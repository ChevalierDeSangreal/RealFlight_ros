...
class HoverTestNode50Hz
{
public:
  explicit HoverTestNode50Hz(ros::NodeHandle& nh, ros::NodeHandle& nh_private, int drone_id);
...
private:
  ...
  // Neural network policy (50Hz version with buffer size 50, REQUIRED)
